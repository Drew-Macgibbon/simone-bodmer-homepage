<template>
  <div class="max-w-full relative top-0 left-0 py-[12px] px-12
       text-black lg:mix-blend-difference glass-bg
      ">
      <div
      class="h-[26px] flex justify-between items-center overflow-hidden transition-all duration-600 ease-in-out"
      ref="topNav"
    >
      <div class="lg:hidden">
      ...
      <div>
        <Icon name="ri:shopping-cart-line" class="text-[26px]"/>
      </div>
    </div>
    <div class="absolute bottom-0 w-[94%] h-[4px] bg-white left-0 right-0 mx-auto 
      lg:invert lg:w-full
    "/>
  </div>
</template>
